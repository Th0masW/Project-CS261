...
var Schedule = function () {
    ...
    _createClass(Schedule, [{
        ...
        value: function SetRange(_ref3) {
            ...
            // special case, if this is a closed range, support not passing in opening and closing times
            if (type === "Closed") {
                if (!openingTime) openingTime = startDate.startOf("day");
                if (!closingTime) closingTime = startDate.endOf("day");
            }
