                    ...
                    this.GetAPIUrl({
                        ...
                        for (var i = 0, product; product = productData[i++];) {
                            if (product.id == "GUEST_PARK_HOURS") {
                                ...
                                return resolve(parseAndFormatScheduleURL(product.purchaseLink));
                            }
                        }
                            ...
                            if (venueData.details) {
                                for (var j = 0, detail; detail = venueData.details[j++];) {
                                    if (detail.id == "info_web_hours_directions") {
                                        ...
                                        return resolve(parseAndFormatScheduleURL(detail.description));
                                    }
                                }
                            }
...
function parseAndFormatScheduleURL(inputUrl) {
    var parsedUrl = url.parse(inputUrl);
    var outputUrl = parsedUrl.protocol + "//" + parsedUrl.hostname;
    outputUrl += parsedUrl.pathname.replace(/park-hours[a-zA-Z0-9_-]*\.htm/, "") + "js/schedule.js";
    return outputUrl;
}
