...
var SilverDollarCity = function (_HerschendBase) {
    _inherits(SilverDollarCity, _HerschendBase);

    /**
     * Create a new SilverDollarCity object
     */
    function SilverDollarCity() {
        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

        _classCallCheck(this, SilverDollarCity);
        ...
        options.park_id = 2;
        options.calendar_url = "www.silverdollarcity.com";
        options.parkids = "D9044234-6D1E-45C1-82D0-0BE80DA34983";

        // inherit from base class
        return _possibleConstructorReturn(this, (SilverDollarCity.__proto__ || Object.getPrototypeOf(SilverDollarCity)).call(this, options));
    }

    return SilverDollarCity;
}(HerschendBase);

module.exports = SilverDollarCity;
//# sourceMappingURL=silverdollarcity.js.map