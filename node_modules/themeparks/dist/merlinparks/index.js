...
var MerlinPark = function (_Park) {
    ...
    function MerlinPark() {
        ...
        // Fallback data
        _this[s_fallbackData] = options.fallback_data;
        return _this;
    }
    ...
    _createClass(MerlinPark, [{
                ...
                return _this3.GenerateUserID().then(function (user_id) {
                    ...
                    return _this3.HTTP({
                        ...
                        headers: {
                            ...
                            "occasio-app-version": _this3[s_appVersion],
        ...
        value: function FetchParkData(version) {
            ...
            return this.MakeAPICall({
                ...
                if (response.statusCode === 304 || response.statusCode === 303) {
                    // reject
                    _this6.Log("Reached status " + response.statusCode + " accessing data version " + version);
                ...
                if (_this6[s_fallbackData]) {
                    return _this6[s_fallbackData];
                }
                throw err;
            });
        }
        ...
        value: function MakeAPICall() {
            ...
            return this.RegisterDevice().then(function (token) {
                ...
                options.headers["occasio-app-version"] = _this7[s_appVersion];
        ...
        key: "applyDateRange",
        value: function applyDateRange(startDate, endDate, isOpen, openingHours) {
